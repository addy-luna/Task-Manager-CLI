// Importing packages and functions needed for the job
...
/* todo is the original task object (task the user needs to update) */
/* helps to keep defaults in case the value remains unchanged or skipped */
    ...
    try {
        ...
        if(!todo){
            ...
            if(update.status === 'completed'){
                ...
                // Deleting the todo
                // {_id: todo._id} is the query object, mongoose will search the whole tasks list with the same id prop to match todo._id
